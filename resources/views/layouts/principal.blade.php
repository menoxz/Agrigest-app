...
<body class="bg-green-100 flex">
    ...
    <div class="sidebar fixed top-0 left-0 h-full w-[260px] bg-green-900 text-white p-5">
        ...
        <div class="mt-6">
            <a href="{{ route('statistiques.globales') }}"
                class="flex items-center space-x-3 py-3 px-4 rounded-md hover:bg-green-700">
            ...
            <a href="{{ route('type-intervention.index') }}"
                class="flex items-center space-x-3 py-3 px-4 rounded-md hover:bg-green-700">
        ...
        <div class="mt-10 border-t border-green-600 pt-5">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit"
                    class="flex items-center space-x-3 py-3 px-4 rounded-md hover:bg-red-700 w-full text-left">
